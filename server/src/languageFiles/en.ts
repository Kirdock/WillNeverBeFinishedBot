...
export const LanguageDictEN: IResponseMessages = {
    ...
    USER_NOT_IN_VOICE_CHANNEL: 'User is not in a channel or channel not found',
    SOUND_NOT_FOUND: 'Desired sound not found',
    SOUND_FETCH_FAILED: 'Failed to fetch any sounds',
    RECORDING_NOT_FOUND: 'Recording not found. Did you forget to activate the record function?',
    SERVER_NOT_FOUND: 'Server id not found',
    SOUND_PLAY_STOPPED: 'Playing stopped',
    SERVER_SETTINGS_UPDATED: 'Settings updated',
