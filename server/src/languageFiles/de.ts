...
export const LanguageDictDE: IResponseMessages = {
    ...
    SOUND_PLAY_STOPPED: 'Dieses Mal lass ich es durch gehen, dass du das stoppst',
    SERVER_SETTINGS_UPDATED: 'Einstellungen wurden aktualisiert. Glaub ja nicht, du bist nun etwas Besonderes',
    LOGIN_FAILED: 'War ja klar, dass der Deutsche es nicht schafft, sich anzumelden',
